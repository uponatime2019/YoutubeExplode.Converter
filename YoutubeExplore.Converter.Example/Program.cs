...
namespace YoutubeExplore.Converter.Example
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            await converter.DownloadAndProcessMediaStreamsAsync(mediaStreamInfos, @"D:\Khanh\Documents\video.mp4", "mp4", new MyProgress());
    ...
    public class MyProgress : IProgress<double>
    {
        ...
        public void Report(double value)
        {
            ...
            {
                Console.WriteLine($"Download progress: {value * 100.0} %");
                previousValue = value;
            }
        }
    }
